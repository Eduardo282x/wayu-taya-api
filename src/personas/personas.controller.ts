...
export class PersonasController {
  ...
  async updatePersonasWithoutProgram(
    @Param('id') id_personas: string,
    @Body() datos: PersonasDTO,
  ) {
    return await this.personasService.updatePersonasWithoutProgram(
      Number(id_personas),
      datos,
    );
  }
  ...
  async updatePersonas(
    @Param('id') id_personas: string,
    @Body() datos: PersonaProgramDTO,
  ) {
    return await this.personasService.updatePersonas(
      Number(id_personas),
      datos,
    );
  }
