  ...
  async generateAdultPDF(): Promise<Buffer> {
    return new Promise((resolve, reject) => {
      ...
      doc
        .font('Helvetica-Bold')
        .fontSize(12)
        .text('AUTORIZACIÓN DE USO DE IMAGEN MAYORES DE EDAD', {
          align: 'center',
          underline: true,
        });
    ...
    `;
      ...
      doc.text(
        'En ___________________, a los ____ días del mes de ________________ de 202__.',
        {
          align: 'left',
        },
      );
      ...
      doc.moveDown(2);
      doc.text(
        'Nombre y Apellido: _________________________________     Firma: _______________________',
        {
          align: 'left',
        },
      );
  ...
  async generateMinorPDF(): Promise<Buffer> {
    return new Promise((resolve, reject) => {
      ...
      doc
        .font('Helvetica-Bold')
        .fontSize(12)
        .text('AUTORIZACIÓN DE USO DE IMAGEN REPRESENTANTE LEGAL', {
          align: 'center',
          underline: true,
        });
    ...
    `;
      ...
      doc.moveDown(0.2);
      doc.text(
        'Nombre y Apellido: ___________________________________     Firma: _________________________',
        {
          align: 'left',
        },
      );
